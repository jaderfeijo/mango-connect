...
#define MCObjectIsNewExceptionDescription @"New objects are not supported by this method"
#define MCObjectAlreadyExistsException @"MCObjectAlreadyExistsException"
#define MCObjectAlreadyExistsExceptionDescription @"The object you are trying to create already exits"
...
#define MCExceptionObjectUserInfoKey @"object"
